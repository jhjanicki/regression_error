	...
	var margin = {top: 30, right: 30, bottom: 100, left: 50},
    	...
    	function exports(_selection) {
			...
			var xAxis;
				...
				y.domain(d3.extent(_data, function(d) { return d[yValue]; }));
				console.log(d3.min(_data, function(d) { return d[yValue]; }));
				console.log(d3.max(_data, function(d) { return d[yValue]; }));
				...
				if(yValue == 'Functional'){
					console.log('log scale');
					console.log(y(0.0015));
					console.log(y(0.8048));
				}
				...
				container
				 ...
				 //y-axis title label
				  ...
				  container.selectAll(".dot2"+_index)
					...
					console.log('xSeries_O');
					console.log(xSeries_O);
					
					console.log('xSeries_G');
					console.log(xSeries_G);
// 					
...
// 					//get the x and y values for least squares
					...
					console.log('dataArray_G');
					console.log(dataArray_G);
					
					console.log('dataArray_O');
					console.log(dataArray_O);
...
// 					  
		...
		exports.ylog = function(value) {
			if (!arguments.length) return ylog;
			ylog = value;
			return this;
		}
